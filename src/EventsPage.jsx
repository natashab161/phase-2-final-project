...
//   const renderEventCards = visibleEvents.filter((event) => {
//     return (
//       event.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       event.category.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       event.subcategory.toLowerCase().includes(searchTerm.toLowerCase()) ||
//       (typeof event.artform === 'string' && event.artform.toLowerCase().includes(searchTerm.toLowerCase()))
//     );
//   }).map((event) => {
//     return <EventCard key={event.id} event={event}></EventCard>;
//   });
...
//           <button class="pageButton" onClick={handleNextClick}>Next</button>)}
//       </div>
//     </div>
//   );
// }
