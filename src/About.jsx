  ...
  return (
    <div className="about-container">
      <div className="about-text-container">
        ...
        <p>
          slide aims to empower local artists to build their careers through
        ...
        <p>
          ...
          sell tickets, and build a following. We help
          ...
          take advantage of all of the tools that slide provides the artist,
